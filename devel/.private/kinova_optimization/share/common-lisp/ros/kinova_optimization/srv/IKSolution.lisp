...
(cl:defmethod cl:initialize-instance :after ((m <IKSolution-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IKSolution-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kinova_optimization-srv:<IKSolution-request> is deprecated: use kinova_optimization-srv:IKSolution-request instead.")))
...
(cl:defmethod init-val ((m <IKSolution-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinova_optimization-srv:init-val is deprecated.  Use kinova_optimization-srv:init instead.")
  (init m))

(cl:ensure-generic-function 'ee_pos_precision-val :lambda-list '(m))
(cl:defmethod ee_pos_precision-val ((m <IKSolution-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinova_optimization-srv:ee_pos_precision-val is deprecated.  Use kinova_optimization-srv:ee_pos_precision instead.")
  (ee_pos_precision m))

(cl:ensure-generic-function 'ee_rot_precision-val :lambda-list '(m))
(cl:defmethod ee_rot_precision-val ((m <IKSolution-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinova_optimization-srv:ee_rot_precision-val is deprecated.  Use kinova_optimization-srv:ee_rot_precision instead.")
  (ee_rot_precision m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<IKSolution-request>)))
  ...
  "kinova_optimization/IKSolutionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IKSolution-request)))
  "Returns string type for a service object of type 'IKSolution-request"
  "kinova_optimization/IKSolutionRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<IKSolution-request>)))
  ...
  "31ace2d87a66926cb643feb651eb2e0b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'IKSolution-request)))
  "Returns md5sum for a message object of type 'IKSolution-request"
  "31ace2d87a66926cb643feb651eb2e0b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<IKSolution-request>)))
  ...
  (cl:format cl:nil "kinova_optimization/EEPoseGoals ee_pose_goals~%kinova_optimization/JointAngles init~%float64 ee_pos_precision~%float64 ee_rot_precision~%~%================================================================================~%MSG: kinova_optimization/EEPoseGoals~%std_msgs/Header header~%geometry_msgs/Pose[] ee_poses~%std_msgs/String notes~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: std_msgs/String~%string data~%~%================================================================================~%MSG: kinova_optimization/JointAngles~%std_msgs/Header header~%std_msgs/Float64MultiArray angles~%std_msgs/String notes~%~%================================================================================~%MSG: std_msgs/Float64MultiArray~%# Please look at the MultiArrayLayout message definition for~%# documentation on all multiarrays.~%~%MultiArrayLayout  layout        # specification of data layout~%float64[]         data          # array of data~%~%~%================================================================================~%MSG: std_msgs/MultiArrayLayout~%# The multiarray declares a generic multi-dimensional array of a~%# particular data type.  Dimensions are ordered from outer most~%# to inner most.~%~%MultiArrayDimension[] dim # Array of dimension properties~%uint32 data_offset        # padding elements at front of data~%~%# Accessors should ALWAYS be written in terms of dimension stride~%# and specified outer-most dimension first.~%# ~%# multiarray(i,j,k) = data[data_offset + dim_stride[1]*i + dim_stride[2]*j + k]~%#~%# A standard, 3-channel 640x480 image with interleaved color channels~%# would be specified as:~%#~%# dim[0].label  = \"height\"~%# dim[0].size   = 480~%# dim[0].stride = 3*640*480 = 921600  (note dim[0] stride is just size of image)~%# dim[1].label  = \"width\"~%# dim[1].size   = 640~%# dim[1].stride = 3*640 = 1920~%# dim[2].label  = \"channel\"~%# dim[2].size   = 3~%# dim[2].stride = 3~%#~%# multiarray(i,j,k) refers to the ith row, jth column, and kth channel.~%~%================================================================================~%MSG: std_msgs/MultiArrayDimension~%string label   # label of given dimension~%uint32 size    # size of given dimension (in type units)~%uint32 stride  # stride of given dimension~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'IKSolution-request)))
  "Returns full string definition for message of type 'IKSolution-request"
  (cl:format cl:nil "kinova_optimization/EEPoseGoals ee_pose_goals~%kinova_optimization/JointAngles init~%float64 ee_pos_precision~%float64 ee_rot_precision~%~%================================================================================~%MSG: kinova_optimization/EEPoseGoals~%std_msgs/Header header~%geometry_msgs/Pose[] ee_poses~%std_msgs/String notes~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: std_msgs/String~%string data~%~%================================================================================~%MSG: kinova_optimization/JointAngles~%std_msgs/Header header~%std_msgs/Float64MultiArray angles~%std_msgs/String notes~%~%================================================================================~%MSG: std_msgs/Float64MultiArray~%# Please look at the MultiArrayLayout message definition for~%# documentation on all multiarrays.~%~%MultiArrayLayout  layout        # specification of data layout~%float64[]         data          # array of data~%~%~%================================================================================~%MSG: std_msgs/MultiArrayLayout~%# The multiarray declares a generic multi-dimensional array of a~%# particular data type.  Dimensions are ordered from outer most~%# to inner most.~%~%MultiArrayDimension[] dim # Array of dimension properties~%uint32 data_offset        # padding elements at front of data~%~%# Accessors should ALWAYS be written in terms of dimension stride~%# and specified outer-most dimension first.~%# ~%# multiarray(i,j,k) = data[data_offset + dim_stride[1]*i + dim_stride[2]*j + k]~%#~%# A standard, 3-channel 640x480 image with interleaved color channels~%# would be specified as:~%#~%# dim[0].label  = \"height\"~%# dim[0].size   = 480~%# dim[0].stride = 3*640*480 = 921600  (note dim[0] stride is just size of image)~%# dim[1].label  = \"width\"~%# dim[1].size   = 640~%# dim[1].stride = 3*640 = 1920~%# dim[2].label  = \"channel\"~%# dim[2].size   = 3~%# dim[2].stride = 3~%#~%# multiarray(i,j,k) refers to the ith row, jth column, and kth channel.~%~%================================================================================~%MSG: std_msgs/MultiArrayDimension~%string label   # label of given dimension~%uint32 size    # size of given dimension (in type units)~%uint32 stride  # stride of given dimension~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <IKSolution-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IKSolution-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kinova_optimization-srv:<IKSolution-response> is deprecated: use kinova_optimization-srv:IKSolution-response instead.")))
...
(cl:defmethod success-val ((m <IKSolution-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kinova_optimization-srv:success-val is deprecated.  Use kinova_optimization-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<IKSolution-response>)))
  ...
  "kinova_optimization/IKSolutionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IKSolution-response)))
  "Returns string type for a service object of type 'IKSolution-response"
  "kinova_optimization/IKSolutionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'IKSolution)))
  ...
  "kinova_optimization/IKSolution")