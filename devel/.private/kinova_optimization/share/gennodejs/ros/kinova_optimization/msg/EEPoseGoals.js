...
// (in-package kinova_optimization.msg)
...
class EEPoseGoals {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('notes')) {
        ...
        this.notes = new std_msgs.msg.String();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = std_msgs.msg.String.serialize(obj.notes, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.notes = std_msgs.msg.String.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += std_msgs.msg.String.getMessageSize(object.notes);
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.notes !== undefined) {
      resolved.notes = std_msgs.msg.String.Resolve(msg.notes)
    }
    else {
      resolved.notes = new std_msgs.msg.String()
    }
